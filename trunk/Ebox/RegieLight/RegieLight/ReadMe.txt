========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet RegieLight
========================================================================

AppWizard a cr&eacute;&eacute; cette application RegieLight pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application RegieLight.
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; RegieLight.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
