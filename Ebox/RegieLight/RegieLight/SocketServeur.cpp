...
char* SocketServeur::BindSocket() 
{
	...
	else
	{
		...
		case WSAEADDRNOTAVAIL:strcpy(MesErr,\
...
char* SocketServeur::AccepterConnection() 
{
	...
	monSocket = accept(monSocket,(sockaddr*)&monAdresse,&sizeof_monAdresse);
	char* MsgAccept = "";
	if(monSocket!= INVALID_SOCKET)
	{
		MsgAccept = "Le serveur accepte les connexionx";
	}
	else
	{
